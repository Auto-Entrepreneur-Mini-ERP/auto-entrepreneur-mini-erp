...
const getAllCustomers = async (autoentrepreneurId) => {
...
const createCustomer = async (authID, customerData) => {
...
const updateCustomer = async (id, customerData) => {
    const data = {};
    // Customer fields
    if (customerData.ice !== undefined)
        data.ice = customerData.ice;
    if (customerData.city !== undefined)
        data.city = customerData.city ?? null;
...
const getAllInvoices = async (customerId, AutoEntrepreneurID) => {
...
const getAllQuotes = async (customerId, AutoEntrepreneurID) => {
