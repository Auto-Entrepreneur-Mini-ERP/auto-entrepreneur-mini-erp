...
const router = Router();
router.get("/contributions", ContributionController.getAllContributions);
router.get("/contributions/:contributionId", ContributionController.getOneContribution);
router.post("/contributions", ContributionController.createContribution);
router.patch("/contributions/:contributionId", ContributionController.modifyContributionStatus);
export default router;
