export const generateQuoteHTML = (quote) => {
    const formatDate = (date) => new Date(date).toLocaleDateString("fr-MA");
  ...
  <body>
    ...
    <div class="header">
      <div>
        ...
        <p><strong>Valable jusqu'au:</strong> ${formatDate(quote.validityDate)}</p>
      </div>
    ...
    <div class="section">
      <h3>Client</h3>
      <p>${quote.customer.user.firstName} ${quote.customer.user.lastName}</p>
...
//# sourceMappingURL=quoteTemplate.js.map