...
export class ServiceService {
    ...
    async getServices(autoEntrepreneurId, filters) {
        const whereClause = {
            isActive: true,
            service: {
    ...
    async getServiceById(id, autoEntrepreneurId) {
    ...
    async updateService(id, autoEntrepreneurId, data) {
        ...
        return prisma.$transaction(async (tx) => {
            ...
            if (data.hourlyRate !== undefined)
                serviceUpdateData.hourlyRate = data.hourlyRate;
            if (data.fixedRate !== undefined)
                serviceUpdateData.fixedRate = data.fixedRate;
            if (data.estimatedDuration !== undefined)
                serviceUpdateData.estimatedDuration = data.estimatedDuration;
    ...
    async deleteService(id, autoEntrepreneurId) {
    ...
    async checkServiceUsage(itemId) {
