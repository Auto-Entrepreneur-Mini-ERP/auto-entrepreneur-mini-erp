/*
  ...
  - You are about to drop the column `articleId` on the `services` table. All the data in the column will be lost.
  - You are about to drop the column `dureeEstimee` on the `services` table. All the data in the column will be lost.
  - You are about to drop the column `tarifFixe` on the `services` table. All the data in the column will be lost.
  - You are about to drop the column `tarifHoraire` on the `services` table. All the data in the column will be lost.
  - You are about to drop the `articles` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `auto_entrepreneurs` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `produits` table. If the table is not empty, all the data it contains will be lost.
  - A unique constraint covering the columns `[itemId]` on the table `services` will be added. If there are existing duplicate values, this will fail.
  - Added the required column `AutoEntrepreneurId` to the `services` table without a default value. This is not possible if the table is not empty.
...
*/
-- DropForeignKey
ALTER TABLE `articles` DROP FOREIGN KEY `articles_autoEntrepreneurId_fkey`;

-- DropForeignKey
ALTER TABLE `produits` DROP FOREIGN KEY `produits_articleId_fkey`;

-- DropForeignKey
ALTER TABLE `services` DROP FOREIGN KEY `services_articleId_fkey`;

-- DropIndex
DROP INDEX `services_articleId_key` ON `services`;

-- AlterTable
ALTER TABLE `services` DROP COLUMN `articleId`,
    DROP COLUMN `dureeEstimee`,
    DROP COLUMN `tarifFixe`,
    DROP COLUMN `tarifHoraire`,
    ADD COLUMN `AutoEntrepreneurId` VARCHAR(191) NOT NULL,
    ADD COLUMN `estimatedDuration` INTEGER NULL,
    ADD COLUMN `fixedRate` DECIMAL(65, 30) NULL DEFAULT 0,
    ADD COLUMN `hourlyRate` DECIMAL(65, 30) NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX `services_itemId_key` ON `services`(`itemId`);
